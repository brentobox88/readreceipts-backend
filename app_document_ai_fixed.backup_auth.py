...
async def get_receipts():
    try:
        ...
        # Query with correct column names (use created_at instead of upload_date)
        cursor.execute('''
        SELECT id, merchant_name, merchant_address, transaction_date, 
               total_amount, tax_amount, currency, filename,
               created_at, confidence_score, status
        FROM receipts
...
async def upload_receipt(file: UploadFile = File(...)):
    ...
    try:
        ...
        INSERT INTO receipts (
            ...
            filename, file_path, processed_at, raw_text,
